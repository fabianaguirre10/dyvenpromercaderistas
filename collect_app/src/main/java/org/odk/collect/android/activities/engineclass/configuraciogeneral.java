...
public class configuraciogeneral extends AppCompatActivity {
    ...
    public String obterImeid() {
        ...
        @SuppressLint("HardwareIds") String myIMEI = Settings.Secure.getString(Collect.getInstance().getApplicationContext().getContentResolver(), androidIdName);
                    ...
                    while(jumpTime < totalProgressTime) {
                        try {
                            ...
                            try {
                                ...
                                Objdatos.put(EstructuraBD.CabecerasEngine.FAccesibilidad,"I");

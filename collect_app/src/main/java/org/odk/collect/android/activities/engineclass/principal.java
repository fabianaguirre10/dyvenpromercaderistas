...
public class principal extends AppCompatActivity {
                    ...
                    builder.setPositiveButton("Asignar Código", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            if (objcodigoSession.getcId() != "") {
                                ...
                                objBranchSeccion.setFAccesibilidadestado("I");
                                objBranchSeccion.setFExtra_visibilidadestado("I");
                                objBranchSeccion.setFInventariosestado("I");
                                objBranchSeccion.setFPosicionamientoestado("I");
                                /*crear codigo nuevo*/
    ...
    public void crearLocalNuevo(){
        ...
        Objdatosingreso.put(EstructuraBD.CabecerasEngine.FAccesibilidad,"I");
        Objdatosingreso.put(EstructuraBD.CabecerasEngine.FExtra_visibilidad,"I");
        Objdatosingreso.put(EstructuraBD.CabecerasEngine.FInventarios,"I");
        Objdatosingreso.put(EstructuraBD.CabecerasEngine.FPosicionamiento,"I");

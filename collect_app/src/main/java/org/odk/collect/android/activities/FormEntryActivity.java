...
import org.odk.collect.android.activities.engineclass.Engine_util;
...
public class FormEntryActivity extends CollectAbstractActivity implements AnimationListener,
    ...
    /*Manejo de estados ejecutados pendientes */
    private boolean cambiarestado(String codigo,String uri){
        try {
            ...
            where1 = where1 + "and code = '" + objB.getE_code() + "'";
            ...
            if (objB.getE_EstadoFormulario().toString().equals("nuevo")) {
                ...
                if (existebaseengine == true && existefisico == true) {
                    ...
                    Objdatosingreso.put(EstructuraBD.CabecerasEngine.name, objB.getE_name());
                    Objdatosingreso.put(EstructuraBD.CabecerasEngine.mainStreet, objB.getE_mainStreet());
                ...
                if (existefisico == true) {
                    ...
                    Objdatos.put(EstructuraBD.CabecerasEngine.LatitudeBranch, objB.getE_LatitudeBranch());
                    Objdatos.put(EstructuraBD.CabecerasEngine.LenghtBranch, objB.getE_LenghtBranch());
                    ...
                    Objdatos.put(EstructuraBD.CabecerasEngine.Facciontipolocal, objB.getFacciontipolocal());
                    String where2 = "code='" + objB.getE_code()
                            + "'";
                    if(objB.getE_EstadoFormulario().toString().equals("e_EstadoFormulario")==false) {
